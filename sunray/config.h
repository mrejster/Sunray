...
#define DRV_ARDUMOWER     1   // keep this for Ardumowerµ
...
#define WHEEL_BASE_CM         70         // wheel-to-wheel distance (cm)        
#define WHEEL_DIAMETER        330        // wheel diameter (mm)                  
...
#define RELAY_MACHINE "klopp"          // choose a unique robot id
...
#define CURRENT_FACTOR 0.1   // PCB1.3 (bridged INA169, max. 5A)
...
#define BLE_NAME      "Klopp"     // name for BLE module
...
#define pinMotorMowSenseLeft A6    // M1_FB  mower motor current sense  
#define pinMotorMowSenseRight A7   // M1_FB  mower motor current sense  
#define pinMotorMowFault 26        // M1_SF  mower motor fault   (if using MOSFET/L298N, keep unconnected)
#define pinMotorMowFaultLeft 47    // M1_SF  mower motor fault   User switch 2
#define pinMotorMowFaultRight 48   // M1_SF  mower motor fault   User switch 3
